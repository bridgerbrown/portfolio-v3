const projectsData = [
  {
    ...
    "type": "Solo-Project",
    "description": "A programming language interpreter is a essential foundational element of many high-level programming languages (ie. JavaScript), allowing the translating and executing of input code. It's comprised of several key components: a lexer for tokenizing input text, an abstract syntax tree (AST) for accurately representing those tokens, a parser for semantic analysis, and an evaluator for executing the appropriate functionality based on that semantic structure. \n\n Building this interpreter was definitely one of the most complicated personal coding projects I’ve done, but also the most interesting and satisfying. It demands a deep understanding of language syntax, semantics, and software architecture to ensure efficient code interpretation. The website was built with a frontend of vanilla JavaScript, HTML, CSS, Xterm.js, and Highlight.js, and the backend with Node.js, Websockets, and Express.js. Check out the website to test the interpreter, see the code, and learn what an interpreter is, how it works, and how I built all of this!",
