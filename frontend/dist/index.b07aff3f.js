...
})({"lg2Ne":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "cb649d02b07aff3f";
"use strict";
...
var _routerJs = require("./services/Router.js");
var _routerJsDefault = parcelHelpers.interopDefault(_routerJs);
var _categoriesJs = require("./services/Categories.js");
var _categoriesJsDefault = parcelHelpers.interopDefault(_categoriesJs);
var _motion = require("motion");
var _pageHeaderJs = require("./components/PageHeader.js");
var _pageHeaderJsDefault = parcelHelpers.interopDefault(_pageHeaderJs);
...
var _projectsJs = require("./views/Projects.js");
var _projectsJsDefault = parcelHelpers.interopDefault(_projectsJs);
var _aboutJs = require("./views/About.js");
var _aboutJsDefault = parcelHelpers.interopDefault(_aboutJs);
var _contactJs = require("./views/Contact.js");
var _contactJsDefault = parcelHelpers.interopDefault(_contactJs);
window.app = {};
const $ = ()=>document.querySelector.call(undefined, arguments);
const $$ = ()=>document.querySelectorAll.call(undefined, arguments);
...
app.router = (0, _routerJsDefault.default);
app.categories = (0, _categoriesJsDefault.default);
window.addEventListener("DOMContentLoaded", ()=>{
    ...
    (0, _motion.animate)(".home__heading-container h1", {
        opacity: [
            0,
            1
        ]
    ...
    (0, _motion.animate)(".home__heading-container h2", {
        opacity: [
            0,
            1
        ]
    ...
    (0, _motion.animate)("project-item", {
        opacity: [
            0,
            1
        ]
        ...
        duration: 0.5,
        easing: "ease-in-out",
        delay: (0, _motion.stagger)(0.3)
    });
});

},{"./services/Router.js":"crL8u","./services/Categories.js":"aAWyj","motion":"aqnbF","./components/PageHeader.js":"9Jh4x","./views/Home.js":"6fDK2","./components/Project.js":"18QBM","./views/Projects.js":"8MfqD","./views/About.js":"h2QJb","./views/Contact.js":"1Hb5k","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"crL8u":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const Router = {
    ...
    go: (route, addToHistory = true)=>{
        ...
        if (pageElement) {
            ...
            } else document.querySelector("main").appendChild(pageElement);
        }
        window.scrollX = 0;
    }
};
...
},{}],"aAWyj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const Categories = {
    category: "all"
...
const proxiedCategories = new Proxy(Categories, {
    set (target, property, value) {
        ...
        if (property == "category") window.dispatchEvent(new Event("categorychange"));
        return true;
    },
    get (target, property) {
...
exports.default = proxiedCategories;
...
},{"@motionone/dom":"krEZT","@motionone/utils":"krBNu","@motionone/animation":"ebY3Z","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9Jh4x":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6fDK2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"18QBM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Project extends HTMLElement {
    connectedCallback() {
        ...
        const builtWith = project.builtWith.map((item, index)=>{
            return index < project.builtWith.length - 1 ? `<span><span class="project__builtWith-item">${item}</span>, </span>` : `<span>and <span class="project__builtWith-item">${item}</span>.</span>`;
        });
        ...
        const disableButtons = (type)=>{
            if (project.buttonsEnabled === "11") return type === "view" ? project.projectLink : project.githubLink;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8MfqD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _projectsDataJs = require("../data/projectsData.js");
var _projectsDataJsDefault = parcelHelpers.interopDefault(_projectsDataJs);
var _projectJs = require("../components/Project.js");
var _projectJsDefault = parcelHelpers.interopDefault(_projectJs);
class Projects extends HTMLElement {
    ...
    getProjectsLength(category) {
        const allProjects = (0, _projectsDataJsDefault.default);
        const featuredProjects = (0, _projectsDataJsDefault.default).filter((project)=>project.featured === "true");
        const soloProjects = (0, _projectsDataJsDefault.default).filter((project)=>project.type === "Solo-Project");
        const workProjects = (0, _projectsDataJsDefault.default).filter((project)=>project.type !== "Solo-Project");
        const selectedProjects = category === "all" ? allProjects : category === "solo-projects" ? soloProjects : category === "featured" ? featuredProjects : workProjects;
...
},{"../data/projectsData.js":"kfcpA","../components/Project.js":"18QBM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kfcpA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const projectsData = [
    {
    ...
    },
    {
        ...
        "builtWith": [
            ...
            "Firestore database",
            "Firebase user authentication",
            "the public art database API of the Art Institute of Chicago"
        ],
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h2QJb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1Hb5k":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lg2Ne","iSwqg"], "iSwqg", "parcelRequire7db1")
